...
const triangleExclamation = (className: string, onClick?: MouseEventHandler) => (<svg className={className} onClick={onClick} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
...
export const IconSvgs = {
    award, backward, barsFilter, barsSort, boxesStacked, calendarDays, check, circleCaretRight, clock, colon, ellipsis, lessThan, list, magnifyingGlass, poop, rankingStar, sort, sparkles, thumbsDown, thumbsUp, triangleExclamation, user, xmark
}
